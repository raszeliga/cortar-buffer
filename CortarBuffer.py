...
/***************************************************************************
 ...
 Generated by Plugin Builder: http://g-sherman.github.io/Qgis-Plugin-Builder/
        ...
        begin                : 2024-06-25
        git sha              : $Format:%H$
        copyright            : (C) 2024 by CortarBuffer
        email                : CortarBuffer
 ***************************************************************************/
...
from .CortarBuffer_dialog import CortarBufferDialog
import os.path
...
class CortarBuffer:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'CortarBuffer_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&CortarBuffer')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('CortarBuffer', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/CortarBuffer/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u''),
            callback=self.run,
